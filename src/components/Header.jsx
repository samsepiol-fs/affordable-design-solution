...
const Header = () => {
    ...
    const toggleNavigation = () => {
        openNavigation ? setOpenNavigation(false) && enablePageScroll() : setOpenNavigation(true) && disablePageScroll();
    }
    const handleClick = () => {
  ...
  return (
    ...
    border-n-6 lg:bg-n-8/90
    lg:backdrop-blur-sm 
    ${openNavigation? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'}`}>
        <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
            <a className='block w-[12rem] xl:mr-8 ' href="/">
                <img src={affordableDesignLogo} alt="affordable-design-solutions" width={190} height={40} />
            </a>
                ...
                <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
                    {navigation.map((item) => (
                        <Link  
                            ...
                            lg:text-xs lg:font-semibold ${item.url === pathname.pathname? 'z-2 lg:text-n-1' : 'lg:text-n-1/50'} 
